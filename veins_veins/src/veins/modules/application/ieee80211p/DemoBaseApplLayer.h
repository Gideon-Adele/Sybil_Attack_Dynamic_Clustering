...
public:
    ...
    static inline std::vector<int> vehicleIDY;
    static inline std::vector<double> speedValues;
    static inline std::vector<int> nodeIds;
    static inline std::vector<int> cluster1, cluster2, cluster3, cluster4, cluster5;
    static inline std::map<int, std::map<int, double>> node_speed3;
    static inline std::map<int, std::map<int, double>> node_speed_map;
    static inline std::map<int, std::map<int, double>> new_node_speed_map;
