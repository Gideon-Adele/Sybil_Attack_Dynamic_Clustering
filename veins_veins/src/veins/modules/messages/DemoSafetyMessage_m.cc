...
void DemoSafetyMessage::copy(const DemoSafetyMessage& other)
{
    ...
    //this->vehicleSpeed = other.vehicleSpeed; //Added
}
...
void DemoSafetyMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
   ...
   // doParsimPacking(b,this->vehicleSpeed); //Addded
}
...
//Added code
std::string DemoSafetyMessage::getVehicleId() const
{
    return this->vehicleId;
}

void DemoSafetyMessage::setVehicleId(std::string vehicleId)
{
    this->vehicleId = vehicleId;
}

std::string DemoSafetyMessage::getVehicleType() const
{
    return this->vehicleType;
}

void DemoSafetyMessage::setVehicleType(std::string vehicleType)
{
    this->vehicleType = vehicleType;
}

double DemoSafetyMessage::getVehicleSpeed() const
{
    return this->vehicleSpeed;
}

void DemoSafetyMessage::setVehicleSpeed(double vehicleSpeed)
{
...
int DemoSafetyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    //if (fieldName[0] == 's' && strcmp(fieldName, "vehicleSpeed") == 0) return base+2; //Added
...
const char *DemoSafetyMessageDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
       ...
       // "veins::Coord",    // FIELD_vehicleSpeed //Added
    };
...
std::string DemoSafetyMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        //case FIELD_vehicleSpeed: {std::stringstream out; out << pp->getVehicleSpeed(); return out.str();} //Added
        default: return "";
    }
}
...
void *DemoSafetyMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        //case FIELD_vehicleSpeed: return toVoidPtr(&pp->getVehicleSpeed()); break; //Added
        default: return nullptr;
    }
}
