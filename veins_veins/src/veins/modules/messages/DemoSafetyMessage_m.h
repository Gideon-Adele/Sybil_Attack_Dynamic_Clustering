...
class VEINS_API DemoSafetyMessage : public ::veins::BaseFrame1609_4
{
  protected:
    ...
    Coord senderSpeed;
    double vehicleSpeed;
    static inline std::string vehicleId;
    static inline std::string vehicleType;
  static inline int vehicleIdtoInt;
  ...
  public:
    ...
    //Added Code
    virtual std::string getVehicleId() const;
    virtual void setVehicleId(std::string vehicleId);
